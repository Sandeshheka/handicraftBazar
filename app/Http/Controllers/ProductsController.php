  ...
  public function addSale(Request $request){
   ...
   $salePrice = $request->salePrice;
    ...
    public function addBanner()
    {
        ...
        return view('admin.sliderbanner.create');
    }

    public function showBanner()
    {
        $banners = Banner::all();
        return view('admin.sliderbanner.index', compact('banners'));
    }
    ...
    public function createBanner(Request $request)
    {
        ...
        $this->validate($request,[
            ...
            'name2'=>'required',
            'discount2'=>'required',
            'image2'=>'image|mimes:png,jpg,jpeg|max:10000'
        ]);
        ...
        $image->move('banner-image', $filename);
        $banner->image = 'banner-image/'.$filename;
        ...
        $banner2->name = $request['name2'];
        $banner2->discount = $request['discount2'];

        $image =$request->file('image2');
        $filename =$image->getClientOriginalName();
        $image->move('banner-image', $filename);
        $banner2->image = 'banner-image/'.$filename;

        $banner2->save();

        Session::flash('message', "Slider Image Added");
        return redirect()->back();
    }
